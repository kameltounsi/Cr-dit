...
<head>
    ...
    <link rel="stylesheet" href="../css/reservation_back.css">
...
<div id="editCarModal" class="modal">
    <div class="modal-content">
        ...
        <h2>Edit Car</h2>
        <form id="editCarForm" action="../Controller/edit_car.php" method="POST" enctype="multipart/form-data">
...
<div id="carModal" class="modal">
    <div class="modal-content">
        ...
        <h2>Add a Car</h2>
        <form id="carForm" action="../Controller/add_car.php" method="POST" enctype="multipart/form-data">
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch('../Controller/delete_car.php', {
                method: 'POST',
                headers: {
...
document.getElementById("carForm").addEventListener("submit", function(event) {
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            fetch('../Controller/affichcars.php')
